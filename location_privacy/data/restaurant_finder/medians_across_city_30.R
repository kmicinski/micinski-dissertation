...
jpeg("./../restaurant_finder/medians_across_city_30.jpg")

# convert factor to numeric for convenience 
Medians <- read.csv("./../restaurant_finder/medians_across_city_30.csv")
locations <- unique(c("new_york","dallas","baltimore","newhaven","redmond","decatur"))
